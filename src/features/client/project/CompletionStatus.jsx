...
import { FaChartLine, FaCalendarDays, FaCircleCheck } from "react-icons/fa6";
      ...
      <CardContent className="pt-5 space-y-4">
        ...
        <div className="border border-border/40 rounded-xl overflow-hidden text-xs bg-muted/10">
          <div className="flex items-center gap-2.5 p-3 border-b border-border/30">
            <FaCalendarDays className="size-3.5 text-primary/70 shrink-0" />
            <div>
          ...
          <div className="flex items-center gap-2.5 p-3">
            {isCompleted ? (
              <>
                <FaCircleCheck className="size-3.5 text-emerald-500 shrink-0" />
                <div>
              ...
              <>
                <FaCalendarDays className="size-3.5 text-muted-foreground/60 shrink-0" />
                <div>
